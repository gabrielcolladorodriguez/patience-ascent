...
LEADERBOARDS = [
    ...
    {
        "vendorIdentifier": "patience_best_glyphLink",
        "referenceName": "Best Arc Weave Time",
        "defaultFormatter": "ELAPSED_TIME_SECOND",
        "submissionType": "BEST_SCORE",
        "scoreSortType": "ASC",
        "localizations": {
            "en-US": {"name": "Arc Weave", "suffix": "sec"},
            "es-ES": {"name": "Tejido Arcano", "suffix": "s"},
            "fr-FR": {"name": "Tisseau d'Arc", "suffix": "s"},
            "de-DE": {"name": "Arkangewebe", "suffix": "s"},
            "ja": {"name": "アークウィーブ", "suffix": "秒"},
        },
    },
    {
        "vendorIdentifier": "patience_best_glyphChain",
        "referenceName": "Best Flux Surge Time",
        "defaultFormatter": "ELAPSED_TIME_SECOND",
        "submissionType": "BEST_SCORE",
        "scoreSortType": "ASC",
        "localizations": {
            "en-US": {"name": "Flux Surge", "suffix": "sec"},
            "es-ES": {"name": "Oleada Flux", "suffix": "s"},
            "fr-FR": {"name": "Flux Ravage", "suffix": "s"},
            "de-DE": {"name": "Flux-Schwall", "suffix": "s"},
            "ja": {"name": "フラックスサージ", "suffix": "秒"},
        },
    },
    {
        "vendorIdentifier": "patience_best_glyphRush",
        "referenceName": "Best Nova Blitz Score",
        "defaultFormatter": "INTEGER",
        "submissionType": "BEST_SCORE",
        "scoreSortType": "DESC",
        "localizations": {
            "en-US": {"name": "Nova Blitz", "suffix": "pts"},
            "es-ES": {"name": "Nova Blitz", "suffix": "pts"},
            "fr-FR": {"name": "Nova Blitz", "suffix": "pts"},
            "de-DE": {"name": "Nova Blitz", "suffix": "Pkt"},
            "ja": {"name": "ノヴァブリッツ", "suffix": "pt"},
        },
    },
    {
        "vendorIdentifier": "patience_best_glyphZen",
        "referenceName": "Best Haze Drift Time",
        "defaultFormatter": "ELAPSED_TIME_SECOND",
        "submissionType": "BEST_SCORE",
        "scoreSortType": "ASC",
        "localizations": {
            "en-US": {"name": "Haze Drift", "suffix": "sec"},
            "es-ES": {"name": "Bruma Serena", "suffix": "s"},
            "fr-FR": {"name": "Brume Lente", "suffix": "s"},
            "de-DE": {"name": "Nebeltreib", "suffix": "s"},
            "ja": {"name": "ヘイズドリフト", "suffix": "秒"},
        },
    },
]
